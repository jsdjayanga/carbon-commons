...
<%@ page import="org.wso2.carbon.operationscenter.stub.types.beans.Server" %>
...
<fmt:bundle basename="org.wso2.carbon.operationscenter.ui.i18n.Resources">
    <carbon:breadcrumb label="operationscenter.servers.page.header"
...
<script type="text/javascript">
    ...
    <div id="middle">
        <h2><fmt:message key="operationscenter.servers.page.header"/></h2>
        ...
        <div id="workArea">
            <form action="" name="applicationsForm" method="post">
                ...
                <table class="styledLeft" id="appTable" width="100%">
                    <thead>
                    <tr>
                        <th><fmt:message key="operationscenter.servers.table.header.id"/></th>
                        <th><fmt:message key="operationscenter.servers.table.header.server"/></th>
                        <th><fmt:message key="operationscenter.servers.table.header.environment"/></th>
                        <th><fmt:message key="operationscenter.servers.table.header.ip"/></th>
                        <th><fmt:message key="operationscenter.servers.table.header.nickname"/></th>
                        <th><fmt:message key="operationscenter.servers.table.header.location"/></th>
                    </tr>
                    </thead>
                    <tbody>
                    <%
                    ...
                    <tr>
                        ...
                        <td><%= server.getServer()%></td>
                        <td><%= server.getEnvironment()%></td>
                        <td><%= server.getIp()%></td>
                        <td><%= server.getNickname()%></td>
